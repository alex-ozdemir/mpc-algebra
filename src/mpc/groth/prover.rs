...
// pub fn msm1(
//     bases: &[MpcCurve<ark_bls12_377::G1Affine>],
//     scalars: &[<ark_bls12_377::Fr as PrimeField>::BigInt],
// ) -> MpcCurve<ark_bls12_377::G1Projective> {
//     MpcCurve::from_shared(VariableBaseMSM::multi_scalar_mul(bases, scalars).val)
// }
// 
// /// Multi-Scalar Multiplication
// pub fn msm2(
//     bases: &[MpcCurve<ark_bls12_377::G2Affine>],
//     scalars: &[<ark_bls12_377::Fr as PrimeField>::BigInt],
// ) -> MpcCurve<ark_bls12_377::G2Projective> {
//     MpcCurve::from_shared(VariableBaseMSM::multi_scalar_mul(bases, scalars).val)
// }
